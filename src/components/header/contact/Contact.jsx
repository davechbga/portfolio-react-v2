        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">davechbga@gmail.com</span>
              <a
                target="_blank"
                href="mailto:davechbga@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+593 987 167 505</span>
              <a
                target="_blank"
                href="https://api.whatsapp.com/send?phone=593987167505&text=Hello, more information!"
                className="contact__button"
              >
                Write me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
